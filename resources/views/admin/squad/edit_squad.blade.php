    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit Squad Name</li>
            </ol>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex no-block align-items-center">
                    <div>
                        <h4 class="card-title">Edit Squad Name</h4>
                ...
                <div class="col-6">
                    <form class="form" method="post" action="{{ route('update.squad',$editData->id)}}">
                        @csrf
                      <div class="mb-3">
